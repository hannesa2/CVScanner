    ...
    public Line merge(Line line) {
        ...
        if (isNearHorizontal() && line.isNearHorizontal()) {
            ...
            if (yDiff < DIFF_THRESHOLD) {
                //Timber.d("SCANNER MERGING: yDiff: " + yDiff + ", line 1: -> start: " + fLine.start + " end: " + fLine.end
                //      + ", line 2: -> start: " + sLine.start + " end: " + sLine.end);
                return merge(Arrays.asList(fLine.start, fLine.end, sLine.start, sLine.end), true);
            }
            //Timber.d("SCANNER NOT MERGING: yDiff: " + yDiff + ", line 1: -> start: " + fLine.start + " end: " + fLine.end
            //      + ", line 2: -> start: " + sLine.start + " end: " + sLine.end);
            ...
            if (xDiff < DIFF_THRESHOLD) {
                //Timber.d("SCANNER MERGING: xDiff: " + xDiff + ", line 1: -> start: " + fLine.start + " end: " + fLine.end
                // + ", line 2: -> start: " + sLine.start + " end: " + sLine.end);
                return merge(Arrays.asList(fLine.start, fLine.end, sLine.start, sLine.end), false);
            }
            //Timber.d("SCANNER NOT MERGING: xDiff: " + xDiff + ", line 1: -> start: " + fLine.start + " end: " + fLine.end
            //      + ", line 2: -> start: " + sLine.start + " end: " + sLine.end);
        }
        return null;
    }
